...
class DinoLoader:
    ...
    def __init__(self, model_name: str = 'dinov2_vits14', device=None, local_repo_path=None):
    ...
    def _load_model(self):
        try:
            ...
            # ===== load local weights =====
            ckpt_path = "/home/snorlax/work/auto_app/FlowPoseDocker/model/dinov2_vits14_pretrain.pth"
