...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/marvin_ros_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/marvin_ros_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/marvin_ros_control/environment/path.sh"
