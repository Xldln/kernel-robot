...
{
  new (message_memory) marvin_msgs::msg::KeypointPose(_init);
}

void KeypointPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<marvin_msgs::msg::KeypointPose *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember KeypointPose_message_member_array[6] = {
  {
    "name",  // name
    ...
    offsetof(marvin_msgs::msg::KeypointPose, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(marvin_msgs::msg::KeypointPose, arm),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(marvin_msgs::msg::KeypointPose, poses),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(marvin_msgs::msg::KeypointPose, constraints),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(marvin_msgs::msg::KeypointPose, speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(marvin_msgs::msg::KeypointPose, gripper_value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KeypointPose_message_members = {
  ...
  6,  // number of fields
  sizeof(marvin_msgs::msg::KeypointPose),
...
get_message_type_support_handle<marvin_msgs::msg::KeypointPose>()
{
  return &::marvin_msgs::msg::rosidl_typesupport_introspection_cpp::KeypointPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, marvin_msgs, msg, KeypointPose)() {
  return &::marvin_msgs::msg::rosidl_typesupport_introspection_cpp::KeypointPose_message_type_support_handle;
}
