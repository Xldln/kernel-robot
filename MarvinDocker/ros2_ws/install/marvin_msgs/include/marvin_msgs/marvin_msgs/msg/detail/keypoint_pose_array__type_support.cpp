...
{
  new (message_memory) marvin_msgs::msg::KeypointPoseArray(_init);
}

void KeypointPoseArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<marvin_msgs::msg::KeypointPoseArray *>(message_memory);
  typed_message->~KeypointPoseArray();
}

size_t size_function__KeypointPoseArray__poses(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<marvin_msgs::msg::KeypointPose> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<marvin_msgs::msg::KeypointPose> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<marvin_msgs::msg::KeypointPose> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const marvin_msgs::msg::KeypointPose *>(
    get_const_function__KeypointPoseArray__poses(untyped_member, index));
  auto & value = *reinterpret_cast<marvin_msgs::msg::KeypointPose *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<marvin_msgs::msg::KeypointPose *>(
    get_function__KeypointPoseArray__poses(untyped_member, index));
  const auto & value = *reinterpret_cast<const marvin_msgs::msg::KeypointPose *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember KeypointPoseArray_message_member_array[2] = {
  {
    ...
    offsetof(marvin_msgs::msg::KeypointPoseArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<marvin_msgs::msg::KeypointPose>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(marvin_msgs::msg::KeypointPoseArray, poses),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KeypointPoseArray_message_members = {
  ...
  2,  // number of fields
  sizeof(marvin_msgs::msg::KeypointPoseArray),
...
get_message_type_support_handle<marvin_msgs::msg::KeypointPoseArray>()
{
  return &::marvin_msgs::msg::rosidl_typesupport_introspection_cpp::KeypointPoseArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, marvin_msgs, msg, KeypointPoseArray)() {
  return &::marvin_msgs::msg::rosidl_typesupport_introspection_cpp::KeypointPoseArray_message_type_support_handle;
}
