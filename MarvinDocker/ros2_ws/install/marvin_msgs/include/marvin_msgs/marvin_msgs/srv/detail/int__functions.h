...
#ifndef MARVIN_MSGS__SRV__DETAIL__INT__FUNCTIONS_H_
#define MARVIN_MSGS__SRV__DETAIL__INT__FUNCTIONS_H_
...
/// Create srv/Int message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * marvin_msgs__srv__Int_Request__init().
...
/// Destroy srv/Int message.
/**
 * It calls
 * marvin_msgs__srv__Int_Request__fini()
...
/// Check for srv/Int message equality.
/**
...
/// Initialize array of srv/Int messages.
/**
...
/// Finalize array of srv/Int messages.
/**
 * It calls
 * marvin_msgs__srv__Int_Request__fini()
...
/// Create array of srv/Int messages.
/**
 * It allocates the memory for the array and calls
 * marvin_msgs__srv__Int_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Int messages.
/**
 * It calls
 * marvin_msgs__srv__Int_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Int message array equality.
/**
...
/// Copy an array of srv/Int messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * marvin_msgs__srv__Int_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_marvin_msgs
...
/**
 * It calls
 * marvin_msgs__srv__Int_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_marvin_msgs
...
/**
 * It allocates the memory for the array and calls
 * marvin_msgs__srv__Int_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_marvin_msgs
...
/**
 * It calls
 * marvin_msgs__srv__Int_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MARVIN_MSGS__SRV__DETAIL__INT__FUNCTIONS_H_
