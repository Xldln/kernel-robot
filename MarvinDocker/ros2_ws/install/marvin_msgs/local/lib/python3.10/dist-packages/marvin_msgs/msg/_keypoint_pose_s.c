...
bool marvin_msgs__msg__keypoint_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("marvin_msgs.msg._keypoint_pose.KeypointPose", full_classname_dest, 43) == 0);
  }
  marvin_msgs__msg__KeypointPose * ros_message = _ros_message;
  {  // name
  ...
  {  // constraints
    ...
    }
    {
      ...
      Py_ssize_t size = 3;
      float * dest = ros_message->constraints;
      for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // gripper_value
    PyObject * field = PyObject_GetAttrString(_pymsg, "gripper_value");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->gripper_value = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of KeypointPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("marvin_msgs.msg._keypoint_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KeypointPose");
  ...
  {  // constraints
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "constraints");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    float * src = &(ros_message->constraints[0]);
  ...
  {  // gripper_value
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->gripper_value);
    {
      int rc = PyObject_SetAttrString(_pymessage, "gripper_value", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
