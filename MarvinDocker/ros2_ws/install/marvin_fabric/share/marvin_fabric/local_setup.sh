...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/marvin_fabric"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/marvin_fabric/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/marvin_fabric/environment/path.sh"
