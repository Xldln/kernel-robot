...
def generate_launch_description():
    ...
    m1_max_arg = DeclareLaunchArgument(
        'Motor1_max_pos', default_value='2.0', description='Manual max pos for Motor1 (if not auto)')
    ...
    m2_max_arg = DeclareLaunchArgument(
        'Motor2_max_pos', default_value='2.0', description='Manual max pos for Motor2 (if not auto)')
